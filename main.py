...
def main():
    ...
    #     Narrower("undyne", [
    #         TagPredicate("undyne"),
    #         TagPredicate("undyne_the_undying")
    #     ])
    # ]
    # k_theme = [
    #     Narrower("sub", [
    #         TagPredicate("submissive"),
    #         TagPredicate("submissive_female")
    #     ]),
    #     Narrower("abuse", [
    #         TagPredicate("abuse"),
    #         TagPredicate("guru"),
    #         TagPredicate("gore")
    #     ]),
    #     Narrower("mind control", [
    #         TagPredicate("mind_control"),
    #         TagPredicate("hypnosis"),
    #         SitePredicate("hypnohub")
    #     ])
    # ]
